...
function main.initEvents()
  ...
  script.on_event("f-a-c-t-o-r-i-o_Inventory_key", function(event)
    pdaUI.InventoryToggle(event)
  end)

  script.on_event("f-a-c-t-o-r-i-o_PDA_main_key", function(event)
    pdaUI.PDAToggle(event)
    pdaUI.InventoryClose(event)
  end)

  script.on_event("f-a-c-t-o-r-i-o_PDA_map_key", function(event)
    pdaUI.PDASetScreen(event, "map")
    pdaUI.PDAToggle(event)
    pdaUI.InventoryClose(event)
  end)

  script.on_event("f-a-c-t-o-r-i-o_PDA_quests_key", function(event)
    pdaUI.PDASetScreen(event, "quest")
    pdaUI.PDAToggle(event)
    pdaUI.InventoryClose(event)
  end)

  script.on_event("f-a-c-t-o-r-i-o_PDA_encyclopedia_key", function(event)
